...
public class SPTool {
    ...
    private final static String SP_NAME_DEFAULT = "atoshi_games_sp";
    ...
    public static void putString(String key, String value) {
        putString(mContext, SP_NAME_DEFAULT, key, value);
    }
    public static String getString(String key) {
        return getString(mContext, SP_NAME_DEFAULT, key);
    }
    /**
     ...
     * @param content 存入的内
     */
    public static void putContent(Context context, String name, String tag, String content) {
        putString(context, name, tag, content);
    }
     ...
     */
    public static String getContent(Context context, String name, String tag) {
        return getString(context, name, tag);
    }
